...
- Phase 0, 1, 1.5는 완료
- factor expansion 기준 Phase 1, 2, 3 baseline 과 Phase 3 refinement 까지 구현 완료
- daily screener, staged intraday collection, Oracle SQL opt-in persistence는 구현 완료
- 현재 관심사는 rule tuning, threshold calibration, review/audit 가시성 보강
...
- reversal / volatility / relative strength threshold calibration
...
- candidate / rejected audit visibility 보강
