...
SCHEMA_STATEMENTS = (
    ...
    BEGIN
      EXECUTE IMMEDIATE '
        CREATE TABLE market_daily_bars (
          ...
          interval_code VARCHAR2(16) DEFAULT ''1d'' NOT NULL,
          adjustment VARCHAR2(32) DEFAULT ''auto_adjust_false'' NOT NULL,
          ...
          volume NUMBER,
          currency VARCHAR2(8),
          source_status VARCHAR2(32),
          fetched_at TIMESTAMP WITH TIME ZONE NOT NULL,
          updated_at TIMESTAMP WITH TIME ZONE DEFAULT SYSTIMESTAMP NOT NULL,
          CONSTRAINT pk_market_daily_bars
            PRIMARY KEY (symbol, trade_date, interval_code, adjustment, provider)
        )';
    EXCEPTION
      WHEN OTHERS THEN
        IF SQLCODE != -955 THEN RAISE; END IF;
    ...
    BEGIN
      EXECUTE IMMEDIATE '
        CREATE TABLE market_data_fetch_log (
          fetch_id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
          provider VARCHAR2(32) NOT NULL,
          request_kind VARCHAR2(64) NOT NULL,
          symbol_count NUMBER,
          start_date DATE,
          end_date DATE,
